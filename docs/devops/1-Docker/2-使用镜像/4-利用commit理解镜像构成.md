...
root@e0cf6739a8f5:/# echo '<h1>hello,docker!</h1>' > /usr/share/nginx/html/index.html
root@e0cf6739a8f5:/# exit
exit
...
```bash
$ docker commit --author "tao wang <twan211@gmail.com>" --message "修改了默认网页" webserver nginx:v2

sha256:ecfe44a2889a02152784d52492e3a0ef4e2f3b983fb0aa8e8854d68923fc015c
...
nginx        v2        ecfe44a2889a   4 minutes ago   142MB
nginx        latest    51086ed63d8c   11 days ago     142MB
...
ecfe44a2889a   5 minutes ago   nginx -g daemon off;                            1.19kB    修改了默认 网页
51086ed63d8c   11 days ago     /bin/sh -c #(nop)  CMD ["nginx" "-g" "daemon…   0B
...
<missing>      11 days ago     /bin/sh -c set -x     && addgroup --system -…   61.1MB
<missing>      11 days ago     /bin/sh -c #(nop)  ENV PKG_RELEASE=1~bullseye   0B
<missing>      11 days ago     /bin/sh -c #(nop)  ENV NJS_VERSION=0.7.6        0B
<missing>      11 days ago     /bin/sh -c #(nop)  ENV NGINX_VERSION=1.23.1     0B
<missing>      11 days ago     /bin/sh -c #(nop)  LABEL maintainer=NGINX Do…   0B
<missing>      12 days ago     /bin/sh -c #(nop)  CMD ["bash"]                 0B
<missing>      12 days ago     /bin/sh -c #(nop) ADD file:b78b777208be08edd…   80.5MB
